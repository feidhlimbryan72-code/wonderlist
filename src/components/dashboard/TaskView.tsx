...
export const TaskView: React.FC<TaskViewProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-hidden text-slate-800 dark:text-white">
      ...
      {/* Task List Header */}
      <header className="p-4 flex items-center justify-between border-b border-slate-200/20 dark:border-white/5 glass-panel bg-white/20 dark:bg-black/10 shrink-0">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        ...
        {/* Task Creation Form */}
        <form onSubmit={handleCreateTask} className="glass-panel p-3 rounded-2xl shadow-sm border border-slate-200/20 dark:border-white/5">
